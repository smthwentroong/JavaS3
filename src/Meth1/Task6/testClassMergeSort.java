...
public class testClassMergeSort {
    ...
    private void fillStudentLists(int length_first, int length_second){
        ...
        for(int i = 0 ; i < length_first; i++) StudentsListFirst[i] = new Student((int)(Math.random() * 100));

        for(int i = 0 ; i < length_second; i++) StudentsListSecond[i] = new Student((int)(Math.random() * 100));
    }
